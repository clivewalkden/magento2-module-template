...
$authorWebsite = ask('Author website', 'https://clivewalkden.co.uk');
...
$useFunding = confirm('Use GitHub Sponsors?', true);

writeln('------');
writeln("Author     : {$authorName} ({$authorUsername}, {$authorEmail}) - $authorWebsite");
...
writeln('Use GitHub Sponsors  : '.($useFunding ? 'yes' : 'no'));
writeln('------');
...
if (! $useFunding) {
    safeUnlink(__DIR__.'/.github/FUNDING.yml');
}
